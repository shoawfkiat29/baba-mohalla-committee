...
function renderSettingsPage() {
  el('page-settings').innerHTML = `
    ...
    <div class="settings-section">
      ...
      <p class="muted">Money already collected before/outside this app. Added on top of everything recorded here for "Collected All-Time" and "Balance in Hand" on the Dashboard.</p>
